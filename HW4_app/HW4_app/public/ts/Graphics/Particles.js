...
var Trace = (function () {
    function Trace(time, x, y, color, duration) {
        this.color = color;
        this.duration = duration;
        this.centerX = x;
        this.centerY = y;
    ...
    Trace.prototype.createParticle = function (t) {
        var that2 = {
    ...
    Trace.prototype.update = function (t) {
        var delta = t - this.lastStamp;
        if (t < this.endTime - this.duration + 100) {
            this.createParticle(t);
        }
...
var Particles = (function () {
    ...
    Particles.addTraceBomb = function (time, x, y) {
        if (Particles.explosions == undefined) {
            Particles.explosions = new Array();
        }
